...
module.exports = async dbObject => {
  ...
  let collections = await dbObject.db.listCollections().toArray(); 
  // se non ci sono collections, db non esiste;
  if ( collections.length <= 0 ) {  
    console.log("There aren't collections")
    dbObject.db.createCollection("changelog")
  }
